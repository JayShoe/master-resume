...
accomplishment_variations	\N	\N	\N	f	f	\N	status	t	archived	draft	sort	all	\N	\N	1	\N	open	\N	f
accomplishments	\N	\N	{{primary_title}} @ {{position.company.name}}	f	f	\N	status	t	archived	draft	sort	all	\N	\N	5	\N	open	\N	f
certifications	\N	\N	\N	f	f	\N	status	t	archived	draft	sort	all	\N	\N	7	\N	open	\N	f
companies	\N	\N	{{name}}	f	f	\N	status	t	archived	draft	sort	all	\N	\N	2	\N	open	{{name}}	f
cover_letters	\N	\N	\N	f	f	\N	status	t	archived	draft	sort	all	\N	\N	2	\N	open	\N	f
education	\N	\N	\N	f	f	\N	status	t	archived	draft	sort	all	\N	\N	3	\N	open	\N	f
positions	\N	\N	{{primary_title}} - {{department}} - {{start_date}} - {{end_date}}	f	f	\N	status	t	archived	draft	sort	all	\N	\N	1	\N	open	\N	f
professional_summaries	\N	\N	\N	f	f	\N	status	t	archived	draft	sort	all	\N	\N	1	\N	open	\N	f
projects	\N	\N	{{name}}	f	f	\N	status	t	archived	draft	sort	all	\N	\N	4	\N	open	\N	f
resumes	\N	\N	\N	f	f	\N	status	t	archived	draft	sort	all	\N	\N	1	\N	open	\N	f
skills	\N	\N	{{name}}	f	f	\N	status	t	archived	draft	sort	all	\N	\N	6	\N	open	\N	f
technologies	\N	\N	\N	f	f	\N	status	t	archived	draft	sort	all	\N	\N	8	\N	open	\N	f
\.
...
SELECT pg_catalog.setval('public.accomplishments_skills_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.accomplishments_technologies_id_seq', 1, false);
